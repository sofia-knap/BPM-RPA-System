...
Sending Email
    ...
    ...        subject=Ablehnung der Bewerbung
    ...        body=Sehr geehrter Bewerber, leider müssen wir Ihnen mitteilen, dass Ihre Bewerbung abgelehnt wurde. Mit freundlichen Grüßen, Ihr Institut